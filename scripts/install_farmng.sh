...
# that ROS 2 Humble uses.
#
# Run this ONCE before building the amiga_slam workspace.
...
echo "    cd ~/amiga_slam && colcon build --symlink-install"
echo ""
echo "[install_farmng] Verify the bridge can start with:"
echo "    source install/setup.bash"
echo "    ros2 launch amiga_bringup amiga_grpc_bridge.launch.py"

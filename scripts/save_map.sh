...
source ~/amiga_slam/install/setup.bash
ros2 launch amiga_bringup slam_localization.launch.py \
...
echo "  or:"
echo "    ros2 launch amiga_bringup slam_localization.launch.py database_path:=$DEST_DIR/rtabmap.db"
